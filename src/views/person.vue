<template>
  <el-container>
    <el-header>
      <label style="font-size: 40px">{{ name }}的个人界面</label>
      <el-dropdown style="font-size: 40px">
